...
>
  ...
  <ul style={{ lineHeight: "1.8" }}>
    <li>Market Open Window: 9:30 AM - 10:15 AM ET</li>
    <li>Midday Window: Blocked by default</li>
    <li>Power Hour Window: 3:00 PM - 4:00 PM ET</li>
    <li>Current Session State: Pending</li>
    <li>Trade Permission: Locked until confirmed</li>
  </ul>
</section>
      <section
  style={{
...
>
  ...
  <h3>Override Review Protocol</h3>

  <ul style={{ lineHeight: "1.8" }}>
    <li>Manual Override: Disabled by default</li>
    <li>Override Reason Required: Yes</li>
    <li>Post-Session Review Required: Yes</li>
    <li>Rule Violation Logged: Pending</li>
...
>
  ...
  <h3>Rule Discipline Scorecard</h3>

  <ul style={{ lineHeight: "1.8" }}>
    <li>Setup Quality: Pending</li>
    <li>Entry Discipline: Pending</li>
    <li>Exit Discipline: Pending</li>
    <li>Risk Compliance: Pending</li>
...
>
  ...
  <ul style={{ lineHeight: "1.8" }}>
    ...
    <li>Direction: Pending</li>
    <li>Entry Trigger: Pending</li>
